...
#define FUNC_PTR(name, value) static auto const name  =  value
	...
	static auto *const pmess7age_delta_remote_player_action_update_header_field_set = reinterpret_cast<field_reference_set *>(0x635120);
...
#define K_COMPILER_NULL_STRING                                        0x5F363C
	...
	namespace Server
	{
		...
		//
		// ENGINE_PTR(wstring*, log_entry_titles,		PTR_NULL, K_LOG_ENTRY_TITLES);
		// ENGINE_PTR(wstring*, log_entry_titles_ref,	PTR_NULL, K_LOG_ENTRY_TITLES_REF);
		//
