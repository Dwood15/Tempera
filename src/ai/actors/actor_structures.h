...
namespace Yelo {
	namespace AI {
		...
		STAT_ASSERT(s_actor_meta_data, 0x5C);
		...
		STAT_ASSERT(s_actor_state_data, 0xB4);

		struct s_actor_input_data {
			//real_point3d : 96; // unknown field
			int : 32;
			int : 32;
			int : 32;
			// real_vector3d : 96; // unknown field
			int : 32;
			int : 32;
			int : 32;
			byte        pad1[32];
		...
		STAT_ASSERT(s_actor_input_data, 0xA8);
		...
		STAT_ASSERT(s_actor_target_data, 0x18);
		...
		STAT_ASSERT(s_actor_danger_zone_data, 0x6C);
		...
		struct s_actor_stimulus_data {
			...
			unsigned char  : 8;
			unsigned short : 16;
			real_vector3d pad_real_vector3dA; // unknown field
			unsigned short : 16; // unknown field
			unsigned short : 16;
			unsigned long  : 32; // unknown field
			unsigned short : 16; // unknown field
		...
		STAT_ASSERT(s_actor_stimulus_data, 0x64);
		...
		STAT_ASSERT(s_actor_emotion_data, 0x68);
		...
		STAT_ASSERT(s_actor_firing_position_data, 0x30);
		...
		STAT_ASSERT(s_actor_orders_data, 0x84);
		...
		STAT_ASSERT(s_actor_control_direction_specification, 0x10);
		...
		struct s_actor_control_data {
			...
			PAD(3, 6);
			// real_vector3d : 96; // unknown field							//	0x12C
			int : 32;
			int : 32;
			int : 32;
			real_vector3d desired_facing_vector;                        //	0x138
			// real_vector3d : 96; // unknown field							//	0x144
			int : 32;
			int : 32;
			int : 32;
			// real_vector3d : 96; // unknown field							//	0x150
			int : 32;
			int : 32;
			int : 32;
			...
			unsigned short : 16;
			// real_vector3d : 96; // unknown field							//	0x170
			int            : 32;
			int            : 32;
			int            : 32;
			PAD(5, 8);
			...
			unsigned char  : 8;
			unsigned short : 16;
			// real_vector3d : 96; // unknown field							//	0x1C0
			int            : 32;
			int            : 32;
			int            : 32;
			...
			// real_vector3d : 96; // unknown field							//	0x1E0
			int           : 32;
			int           : 32;
			int           : 32;
			// real_point3d : 96; // unknown field							//	0x1EC
			int           : 32;
			int           : 32;
			int           : 32;
			PAD(7, 12);
			// real_point3d : 96; // unknown field							//	0x204
			int            : 32;
			int            : 32;
			int            : 32;
			// real_point3d : 96; // unknown field							//	0x210
			int            : 32;
			int            : 32;
			int            : 32;
			...
			// real_vector3d : 96; // unknown field							//	0x23C
			int            : 32;
			int            : 32;
			int            : 32;
		...
		STAT_ASSERT(s_actor_control_data, 0x2B8);
#pragma pack(push, 1)
		struct s_actor_datum {
			...
			unsigned char  padA[5]; // unknown field
			unsigned char  : 8;
			unsigned short : 16;
		...
		STAT_ASSERT(s_actor_datum, 0x724);
#pragma pack(pop)
		...
		STAT_ASSERT(s_swarm_datum, 0x98);
