...
namespace Yelo::Rasterizer::ShaderExtension {
	constexpr int intk_vector_4_count      = 3;
	constexpr int k_shader_constant_offset = 5;
	...
	namespace Environment {
		...
		void SetupLightmapShader(const TagGroups::s_shader_definition *shader, const short extension_type);
