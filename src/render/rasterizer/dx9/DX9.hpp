...
struct COLOR_VERTEX {
	...
	inline void Set(float _x, float _y, float _z, float _rhw, D3DCOLOR _color) {
		x     = _x;
		y     = _y;
		z     = _z;
		rhw   = _rhw;
	...
	inline void Set(float _x, float _y, float _z, float _rhw, float _a, float _r, float _g, float _b) {
		x     = _x;
		y     = _y;
		z     = _z;
		rhw   = _rhw;
...
struct TEXTURE_VERTEX {
	...
	inline void Set(float _x, float _y, float _z, float _rhw, float _u, float _v) {
		x   = _x;
		y   = _y;
		z   = _z;
		rhw = _rhw;
